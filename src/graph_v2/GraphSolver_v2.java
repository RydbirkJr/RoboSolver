...
public class GraphSolver_v2 implements IGameSolver {
     ...
     * @param graph the vertices.
     * @param fields the fields - needed for the can-move properties.
     * @param row 0-indexed goalRobotRow number for insertion of a robot.
     * @param col 0-indexed goalRobotCol number for insertion of a robot.
     */
     ...
     * @param row 0-indexed goalRobotRow number for the robot to be removed.
     * @param col 0-indexed goalRobotCol number for the robot to be removed.
     */
     ...
     * in case the two robots R1 and R2's start positions are on the same goalRobotCol / goalRobotRow and no obstacles in between, when removing
     ...
     * @param graph The given vertices.
     * @param fields The given fields.
     * @param row 0-indexed goalRobotRow number for the to-vertex.
     * @param col 0-indexed goalRobotCol number for the to-vertex.
     * @return
     */
